...
type Preview={total:number;estimated_input_chars:number;estimated_prompt_tokens:number;estimated_seconds:number;safety:{open:boolean;reason_codes:string[]}};
