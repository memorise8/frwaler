# -*- coding: utf-8 -*-
"""Crawler for ASN/ASNR "Rapports de l'ASNR" (annual safety reports).

Starting URL: https://www.asn.fr/information/publications/rapports-de-l-asnr
(redirects to https://reglementation-controle.asnr.fr/information/publications/rapports-de-l-asnr)

HTML site (eZ Platform CMS). Paginated list: page 1 has no ?page= param, then ?page=2, ?page=3 …
Each item links to a detail page with full body (.RichText) and PDF download links.
"""
...
# The canonical starting URL redirects here:
_REAL_BASE = "https://reglementation-controle.asnr.fr"
_LIST_PATH = "/information/publications/rapports-de-l-asnr"
...
class AsnFrInformationCrawler(BaseCrawler):
    site_id = "asn-fr-information"
    site_name = "Custom: asn-fr-information"
    base_url = "https://www.asn.fr"
    ...
    def crawl(self, limit=None):
        ...
        while True:
            ...
            print(f"[{self.site_id}] page {page}: {len(articles)} articles")
                ...
                try:
                    ...
                    if detail_raw:
                        ...
                        if dsoup:
                            ...
                            if rich:
                                # Collect only .ezrichtext-field text, not link labels
                                parts = []
                            ...
                            for a in dsoup.find_all("a", href=True):
                                ...
                                if h_low.endswith(".pdf") or (
                                    ...
                                    # Extract numeric content ID from /content/download/{id}/
                    ...
                    paper = {
                        ...
                        "authors": None,
                        "publisher": "Autorité de sûreté nucléaire et de radioprotection",
                        "department": None,
                        "journal": None,
                        "url": detail_url,
                        "pdf_url": pdf_url,
                        "keywords": None,
                        "category": "Rapports de l'ASNR",
                        "doi": None,
...
def _parse_date_fr(raw: str) -> str:
