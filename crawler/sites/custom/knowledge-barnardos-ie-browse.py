# -*- coding: utf-8 -*-
"""Crawler for the Barnardos Knowledge Bank title browse.

Starting URL:
    https://knowledge.barnardos.ie/browse/title

The Angular browse page is backed by DSpace 9 REST:
...
class KnowledgeBarnardosIeBrowseCrawler(BaseCrawler):
    site_id = "knowledge-barnardos-ie-browse"
    site_name = "Custom: knowledge-barnardos-ie-browse"
    base_url = "https://knowledge.barnardos.ie"
