# -*- coding: utf-8 -*-
"""EHESS HAL Science search crawler.

Uses the public HAL Solr API (api.archives-ouvertes.fr/search/EHESS/) to
collect reports and other open-access documents submitted with attached
files from the École des Hautes Études en Sciences Sociales (EHESS) HAL
portal.

Starting URL reference:
  https://ehess.hal.science/search/index/?q=%2A&rows=30&submitType_s=file&docType_s=REPORT+OR+OTHER
"""
...
_API_URL = "https://api.archives-ouvertes.fr/search/EHESS/"
_FIELDS = (
...
class EhessHalScienceSearchCrawler(BaseCrawler):
    site_id = "ehess-hal-science-search"
    site_name = "Custom: ehess-hal-science-search"
    base_url = "https://ehess.hal.science"
