# -*- coding: utf-8 -*-
"""Crawler for Eesti Maaülikool (EMÜ) DSpace repository — master's theses search."""
...
class DspaceEmuEeSearchCrawler(BaseCrawler):
    site_id = "dspace-emu-ee-search"
    site_name = "Custom: dspace-emu-ee-search"
    base_url = "https://dspace.emu.ee"

    API_BASE = "https://dspace.emu.ee/server/api"
    SEARCH_FILTERS = (
        "f.has_content_in_original_bundle=true,equals"
        "&f.subject=" + quote("magistritööd") + ",equals"
    )
    PAGE_SIZE = 20
    ...
    def _parse_item(self, uuid, indexable, full_data, detail_url):
        ...
        category = self._first_meta(meta, "dc.type") or "Master Thesis"
        ...
        metadata_raw = {
            ...
            "date_defensed": self._first_meta(meta, "dc.date.defensed") or None,
