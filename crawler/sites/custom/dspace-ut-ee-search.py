# -*- coding: utf-8 -*-
"""Crawler for the University of Tartu (UT) DSpace repository — master's theses search."""
...
class DspaceUtEeSearchCrawler(BaseCrawler):
    ...
    def _parse_item(self, uuid, indexable, full_data, detail_url):
        ...
        publisher = self._first_meta(meta, "dc.publisher") or "Tartu Ülikool"
        ...
        metadata_raw = {
            ...
            "description_uri": self._first_meta(meta, "dc.description.uri") or None,
