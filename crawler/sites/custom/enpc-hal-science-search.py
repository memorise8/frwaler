# -*- coding: utf-8 -*-
"""Crawler for ENPC records in HAL Science search."""
...
class EnpcHalScienceSearchCrawler(BaseCrawler):
    site_id = "enpc-hal-science-search"
    site_name = "Custom: enpc-hal-science-search"
    base_url = "https://enpc.hal.science"

    _START_URL = (
        "https://enpc.hal.science/search/index/?q=%2A&rows=30"
        "&submitType_s=file&docType_s=REPORT+OR+OTHER"
    )
    _SEARCH_API = "https://api.archives-ouvertes.fr/search/enpc/"
    _PAGE_SIZE = 30
