# -*- coding: utf-8 -*-
"""ENSSIB HAL Science search crawler.

Uses the public HAL Solr API (api.archives-ouvertes.fr/search/) to collect
reports and other document types submitted with attached files from the
ENSSIB (École nationale supérieure des sciences de l'information et des
bibliothèques) HAL portal.

Starting URL reference:
  https://enssib.hal.science/search/index/?q=%2A&rows=30&submitType_s=file&docType_s=REPORT+OR+OTHER
"""
...
_API_URL = "https://api.archives-ouvertes.fr/search/enssib/"
_FIELDS = (
...
class EnssibHalScienceSearchCrawler(BaseCrawler):
    site_id = "enssib-hal-science-search"
    site_name = "Custom: enssib-hal-science-search"
    base_url = "https://enssib.hal.science"
