# -*- coding: utf-8 -*-
"""Arts et Métiers HAL Science search crawler.

Uses the public HAL Solr API (api.archives-ouvertes.fr/search/) to collect
reports and other documents with attached files from Arts et Métiers
Sciences et Technologies (ENSAM).

Starting URL reference:
  https://artsetmetiers.hal.science/search/index/?q=%2A&rows=30&submitType_s=file&docType_s=REPORT+OR+OTHER
"""
...
class ArtsetmetiersHalScienceSearchCrawler(BaseCrawler):
    site_id = "artsetmetiers-hal-science-search"
    site_name = "Custom: artsetmetiers-hal-science-search"
    base_url = "https://artsetmetiers.hal.science"
