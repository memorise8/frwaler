# -*- coding: utf-8 -*-
"""IRIS — University of Trento repository crawler (OAI-PMH, DIDL).
...
full catalogue (~133k records). So this crawler harvests OAI-PMH instead of
scraping HTML.
...
ref="https://iris.unitn.it/bitstream/.../file.pdf">`` — so title, abstract and
...
class IrisUnitnItCrawler(BaseCrawler):
    site_id = "iris-unitn-it"
    site_name = "Custom: iris-unitn-it"
    base_url = "https://iris.unitn.it"
